...
print("--------------------------------------------------------------------------------------------------------------")
print("1.Clustering Coefiiant")
print("--------------------------------------------------------------------------------------------------------------")
print('1.1.triangles', nx.triangles(G))
print("--------------------------------------------------------------------------------------------------------------")
print('1.2.transitivity', nx.transitivity(G))
print("--------------------------------------------------------------------------------------------------------------")
print('1.3.Clustering', nx.clustering(G))
print("--------------------------------------------------------------------------------------------------------------")
print('1.4.Average Clustering', nx.average_clustering(G))
print("--------------------------------------------------------------------------------------------------------------")
print('1.5.Square Clustering', nx.square_clustering(G))
print("--------------------------------------------------------------------------------------------------------------")
print('1.6.Generalized Degree', nx.generalized_degree(G))
print("--------------------------------------------------------------------------------------------------------------")
...
# print("--------------------------------------------------------------------------------------------------------------")
# print("4.Beetweeness Centrality")
# print("--------------------------------------------------------------------------------------------------------------")
...
# data1 = data['sourceNodeId'].value_counts
# data.info()

# colnames = ['sourceNodeId', 'targetNodeId']

# data1 = pd.read_csv('edges.csv', header=None)

# source = data.sourceNodeId
# des = data.targetNodeId


# data = [('John'), ('Jane'), ('Bob')]

# data_str = ','.join('({},{})'.format(source, des) for source, des in data)
# data_str = ','.join('({},{})'.format(name, age) for name, age in data)
# G = nx.DiGraph()
...
# data_str = ','.join('({}, {})'.format(num1, num2) for num1, num2 in data)

# G.add_edges_from(data_str)
# plt.figure()
