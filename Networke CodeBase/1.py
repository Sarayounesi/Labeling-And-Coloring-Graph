...
sorted_data = sorted(nx.degree_centrality(G), reverse=True)
top_5 = sorted_data[0:5]
print('2.1.Deegree Centrality', top_5 ,5)
...
# print('3.2.Incremental Closeness Centrality', nx.incremental_closeness_centrality(G))
print("--------------------------------------------------------------------------------------------------------------")
...
print("--------------------------------------------------------------------------------------------------------------")
# print('6.1.Katz Centrality', nx.katz_centrality(G) )
